...
1. **Вывести Media OS в онлайн.**
2. **Сделать мобильную версию Cockpit.**
3. **Поработать в Media OS на реальных задачах и потюнить UX.**
4. **Довести один документ до публикации**, используя только Media OS как систему управления работой.
5. **Сделать публичные страницы сайта:**
   - блог;
   - страница статьи.
6. **Опубликовать первый пост** на временном домене и разослать ссылку близким для обратной связи.
